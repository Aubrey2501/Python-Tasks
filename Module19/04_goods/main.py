...
for i_name in goods:
    i_code = goods[i_name]
    # TODO Круто, но лучше использовать один вложенный цикл и делать расчеты сразу руками "+="
    #  Также куда проще использовать вхождение "in store[i_code]" получив сразу словари
